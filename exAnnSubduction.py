...
densityField = mesh.add_variable(1)
# %%
...
fieldDict["meshDensity"] = densityField
...
# figVdot.show()
# %%
airDensity = nd(1.0 * u.kilogram / u.meter ** 3)
...
meshBuoyancyField = -nd(gravity) * densityField * mesh.unitvec_r_Fn
# %%
...
def project_tomesh():
    if uw.mpi.rank == 0:
        print("Projecting From Swarm to mesh .... ")
    projDensityMesh.solve()
    # meshBuoyancyField = -nd(gravity) * densityField * mesh.unitvec_r_Fn
    projVisMesh.solve()
    uw.mpi.barrier()
